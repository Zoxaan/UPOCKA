...
--
-- Хост: 127.0.0.1
-- Время создания: Апр 11 2024 г., 16:57
...
(4, 'Vova Kornevйцу', 4, 'Бл бы мне еще в рот дали', '2024-04-08 15:51:46'),
...
INSERT INTO `tables` (`id`, `name_table`, `quantity`, `status`, `img`, `description`) VALUES
(45, 'Стол 1', '4', 'забронированный', 'uploads/1stol.jpg', 'Уютный столик для четырех человек.'),
(46, 'Стол 2', '2', 'Забронированный', 'uploads/2stol.jpg', 'Столик для романтического ужина вдвоем.'),
(47, 'Стол 3', '6', 'Свободен', 'uploads/3stol.jpg', 'Большой стол для компании из шести человек.'),
(48, 'Стол 4', '3', 'Забронированный', 'uploads/4stol.jpg', 'Столик для небольшой компании.'),
(49, 'Стол 5', '5', 'Свободен', 'uploads/5stol.jpg', 'Удобный стол для пятерых гостей.'),
(50, 'Стол 6', '4', 'Свободен', 'uploads/6stol.jpg', 'Еще один уютный столик для четырех человек.');
